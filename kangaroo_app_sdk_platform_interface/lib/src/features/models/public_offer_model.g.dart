...
part of 'public_offer_model.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

PublicOfferModel _$PublicOfferModelFromJson(Map<String, dynamic> json) =>
    $checkedCreate(
      'PublicOfferModel',
      json,
      ($checkedConvert) {
...
Map<String, dynamic> _$PublicOfferModelToJson(PublicOfferModel instance) =>
    <String, dynamic>{
      'id': instance.id,
