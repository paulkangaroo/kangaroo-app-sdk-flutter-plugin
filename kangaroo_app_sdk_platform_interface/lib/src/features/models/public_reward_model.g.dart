...
part of 'public_reward_model.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

PublicRewardModel _$PublicRewardModelFromJson(Map<String, dynamic> json) =>
    $checkedCreate(
      'PublicRewardModel',
      json,
      ($checkedConvert) {
...
Map<String, dynamic> _$PublicRewardModelToJson(PublicRewardModel instance) =>
    <String, dynamic>{
      'id': instance.id,
