...
part 'offer_reward_data_model.g.dart';


@JsonSerializable(explicitToJson: true, fieldRename: FieldRename.snake, checked: true, disallowUnrecognizedKeys: true,)
class OfferRewardDataModel {
  ...
  factory OfferRewardDataModel.fromJson(Map<String, dynamic> data) => _$OfferRewardDataModelFromJson(data);

  Map<String, dynamic> toJson() => _$OfferRewardDataModelToJson(this);
}
