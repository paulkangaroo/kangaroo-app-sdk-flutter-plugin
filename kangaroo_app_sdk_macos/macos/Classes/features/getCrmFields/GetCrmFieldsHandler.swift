...
class GetCrmFieldsHandler: NSObject, FlutterStreamHandler, PluginChannelHandler {
    ...
    func onMethodCall(call: FlutterMethodCall) async -> Any? {
        return await GetCrmFieldsHandler.getCrmFields(call: call)
    }
    ...
    static func getCrmFields(call: FlutterMethodCall) async -> String? {
    ...
    do {
        ...
        let result = try await GetCrmFieldsApi().getCrmFields(overrideHeaders: overrideHeaders).serializeGetCrmFieldsApiResult()
