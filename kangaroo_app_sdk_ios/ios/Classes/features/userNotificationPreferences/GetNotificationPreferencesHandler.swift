...
class GetNotificationPreferencesHandler: NSObject, FlutterStreamHandler, PluginChannelHandler {
    var sink: FlutterEventSink?

    var methodChannel: String = "customer_sdk/methods/get_notification_preferences"
    ...
    func onListen(withArguments arguments: Any?, eventSink events: @escaping
        ...
        sink = events
        GetNotificationPreferencesApi().getNotificationPreferencesState
            .serializeGetNotificationPreferencesState().observe { result in
            switch result {
