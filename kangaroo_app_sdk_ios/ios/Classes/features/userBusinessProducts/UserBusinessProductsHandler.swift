...
class UserBusinessProductsHandler: NSObject, FlutterStreamHandler, PluginChannelHandler {
    var sink: FlutterEventSink?

    var methodChannel: String = "customer_sdk/methods/get_user_business_products"
    ...
    func onListen(withArguments arguments: Any?, eventSink events: @escaping
        ...
        sink = events
        UserBusinessProductsApi().userBusinessProductsState
            .serializeUserBusinessProductsState().observe { result in
            switch result {
