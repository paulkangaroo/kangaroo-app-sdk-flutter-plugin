...
class GetDefaultBusinessIdHandler: NSObject, FlutterStreamHandler, PluginChannelHandler {
    var sink: FlutterEventSink?

    var methodChannel: String = "customer_sdk/methods/get_default_business_id"
    ...
    func onListen(withArguments arguments: Any?, eventSink events: @escaping
        ...
        sink = events
        GetDefaultBusinessIdApi().getDefaultBusinessIdState
            .serializeGetDefaultBusinessIdState().observe { result in
            switch result {
