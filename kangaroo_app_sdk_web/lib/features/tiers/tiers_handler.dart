...
class TiersHandler extends TiersApiInterface
  ...
  getTiers({ 
    ...
    final Future<String?> request = TiersApi().getTiers(
...
extension type TiersApi._(JSObject _) implements JSObject {
  external factory TiersApi();

  external JSPromise<JSString?> getTiers( 
