...
class UserBusinessGiftCardsHandler extends UserBusinessGiftCardsApiInterface
  ...
  getUserBusinessGiftCards({ 
    ...
    final Future<String?> request = UserBusinessGiftCardsApi().getUserBusinessGiftCards(
...
extension type UserBusinessGiftCardsApi._(JSObject _) implements JSObject {
  external factory UserBusinessGiftCardsApi();

  external JSPromise<JSString?> getUserBusinessGiftCards( 
