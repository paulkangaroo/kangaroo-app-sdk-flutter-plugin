...
class UserUnsubscribeHandler extends UserUnsubscribeApiInterface
  ...
  unsubscribe({ 
    ...
    final Future<String?> request = UserUnsubscribeApi().unsubscribe(
...
extension type UserUnsubscribeApi._(JSObject _) implements JSObject {
  external factory UserUnsubscribeApi();
