...
class UserCheckInHandler extends UserCheckInApiInterface
  ...
  userCheckIn({ 
    ...
    final Future<String?> request = UserCheckInApi().userCheckIn(
...
extension type UserCheckInApi._(JSObject _) implements JSObject {
  external factory UserCheckInApi();

  external JSPromise<JSString?> userCheckIn( 
