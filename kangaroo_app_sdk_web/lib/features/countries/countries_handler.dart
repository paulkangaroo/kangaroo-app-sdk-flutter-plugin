...
class CountriesHandler extends CountriesApiInterface
  ...
  getCountries({ 
    ...
    final Future<String?> request = CountriesApi().getCountries(
...
extension type CountriesApi._(JSObject _) implements JSObject {
  external factory CountriesApi();

  external JSPromise<JSString?> getCountries( 
