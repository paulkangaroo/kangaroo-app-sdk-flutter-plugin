...
class UserBusinessOffersHandler extends UserBusinessOffersApiInterface
  ...
  getUserBusinessOffers({ 
    ...
    final Future<String?> request = UserBusinessOffersApi().getUserBusinessOffers(
...
extension type UserBusinessOffersApi._(JSObject _) implements JSObject {
  external factory UserBusinessOffersApi();

  external JSPromise<JSString?> getUserBusinessOffers( 
