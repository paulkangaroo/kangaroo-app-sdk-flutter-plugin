...
class GetNotificationPreferencesHandler extends GetNotificationPreferencesApiInterface
  ...
  getNotificationPreferences({ 
    ...
    final Future<String?> request = GetNotificationPreferencesApi().getNotificationPreferences(
...
extension type GetNotificationPreferencesApi._(JSObject _) implements JSObject {
  external factory GetNotificationPreferencesApi();

  external JSPromise<JSString?> getNotificationPreferences( 
