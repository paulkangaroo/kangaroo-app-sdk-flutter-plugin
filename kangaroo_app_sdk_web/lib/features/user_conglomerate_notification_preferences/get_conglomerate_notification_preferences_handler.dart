...
class GetConglomerateNotificationPreferencesHandler extends GetConglomerateNotificationPreferencesApiInterface
  ...
  getConglomerateNotificationPreferences({ 
    ...
    final Future<String?> request = GetConglomerateNotificationPreferencesApi().getConglomerateNotificationPreferences(
...
extension type GetConglomerateNotificationPreferencesApi._(JSObject _) implements JSObject {
  external factory GetConglomerateNotificationPreferencesApi();

  external JSPromise<JSString?> getConglomerateNotificationPreferences( 
