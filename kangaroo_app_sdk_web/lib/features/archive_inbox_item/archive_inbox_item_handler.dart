...
class ArchiveInboxItemHandler extends ArchiveInboxItemApiInterface
  ...
  archiveInboxItem({ 
    ...
    final Future<String?> request = ArchiveInboxItemApi().archiveInboxItem(
...
extension type ArchiveInboxItemApi._(JSObject _) implements JSObject {
  external factory ArchiveInboxItemApi();

  external JSPromise<JSString?> archiveInboxItem( 
