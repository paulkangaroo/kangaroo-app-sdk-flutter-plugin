...
class UserBusinessFrequentBuyerProgramsHandler extends UserBusinessFrequentBuyerProgramsApiInterface
  ...
  getUserBusinessFrequentBuyerPrograms({ 
    ...
    final Future<String?> request = UserBusinessFrequentBuyerProgramsApi().getUserBusinessFrequentBuyerPrograms(
...
@JS('js.features.userBusinessFrequentBuyerPrograms.UserBusinessFrequentBuyerProgramsApi')
extension type UserBusinessFrequentBuyerProgramsApi._(JSObject _) implements JSObject {
  external factory UserBusinessFrequentBuyerProgramsApi();

  external JSPromise<JSString?> getUserBusinessFrequentBuyerPrograms( 
